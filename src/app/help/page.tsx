      ...
      <main className="container mx-auto px-4 py-8 pb-24 max-w-3xl">
        ...
        <div className="bg-orange-50 rounded-xl p-6">
          ...
          <div className="space-y-3">
            <a href="mailto:support@orderwala.in" className="flex items-center gap-3 text-sm text-gray-700 hover:text-orange-600">
              <Mail className="h-4 w-4 text-orange-600" />
              support@orderwala.in
            </a>
            <a href="tel:+919876543210" className="flex items-center gap-3 text-sm text-gray-700 hover:text-orange-600">
